...
{% for sr in object_list if cl.id in sr.availability_set.values_list("clientele__id",flat=True) %} 
 {% if loop.changed(sr.service.category.name) %}
  ...
  Beschreibung:&{{sr.description | latex_escape | latex_internal_links}}\\
  {% if show_usage_information and sr.usage_information %}Zu beachten:&{{sr.usage_information | latex_escape_markdown | latex_internal_links }}\\{% endif %}
  {% if show_requirements and sr.requirements %}Voraussetzungen:&{{sr.requirements | latex_escape_markdown | latex_internal_links }}\\{% endif %}
  {% if show_details and sr.details %}Details:&{{sr.details | latex_escape_markdown | latex_internal_links }}\\{% endif %}
  {% if show_options and sr.options %}Optionen:&{{sr.options | latex_escape_markdown | latex_internal_links }}\\{% endif %}
...
{% for sr in object_list %} 
 {% if loop.changed(sr.service.category.name) %}
  ...
  Beschreibung:&{{sr.description | latex_escape | latex_internal_links}}\\
  {% if show_usage_information and sr.usage_information %}Zu beachten:&{{sr.usage_information | latex_escape_markdown | latex_internal_links }}\\{% endif %}
  {% if show_requirements and sr.requirements %}Anforderungen:&{{sr.requirements | latex_escape_markdown | latex_internal_links }}\\{% endif %}
  {% if show_details and sr.details %}Details:&{{sr.details | latex_escape_markdown | latex_internal_links }}\\{% endif %}
  {% if show_options and sr.options %}Optionen:&{{sr.options | latex_escape_markdown | latex_internal_links }}\\{% endif %}
  {% if show_service_level and sr.service_level %}Service Level:&{{sr.service_level | latex_escape_markdown | latex_internal_links }}\\{% endif %}
  {% if sr.url %}Link zum Service:&\href{ {{- sr.url -}} }{ {{- sr.url | latex_escape -}} }\\{% endif %}
